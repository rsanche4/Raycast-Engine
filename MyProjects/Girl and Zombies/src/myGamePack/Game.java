...
public class Game extends JFrame implements Runnable{
	...
	public static String game_title = "Girl&Zombies";
	...
	public Game() {
		...
		camera = new Camera(mapWidth/2, mapHeight/2, 1, 0, 0, -.66);
		...
		setResizable(false);
		//setUndecorated(true);
		ImageIcon img = new ImageIcon("C:\\Users\\rafas\\eclipse-workspace\\LURG\\res\\icon.png");
	...
	public void run() {
		...
		Sound.playSound("C:\\Users\\rafas\\eclipse-workspace\\LURG\\res\\menu.wav", true);
		while(running) {

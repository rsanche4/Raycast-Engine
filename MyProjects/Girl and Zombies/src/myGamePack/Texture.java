...
public class Texture { // keep all textures to .png
	...
	public static Texture menu_background1 = new Texture("C:\\Users\\rafas\\eclipse-workspace\\LURG\\res\\1menu.png", menu);
	public static Texture menu_background2 = new Texture("C:\\Users\\rafas\\eclipse-workspace\\LURG\\res\\2menu.png", menu);
	
	// others
	public static Texture pistol_texture1 = new Texture("C:\\Users\\rafas\\eclipse-workspace\\LURG\\res\\pistol0.png", other);
	public static Texture pistol_texture2 = new Texture("C:\\Users\\rafas\\eclipse-workspace\\LURG\\res\\pistol1.png", other);
	public static Texture pistol_texture3 = new Texture("C:\\Users\\rafas\\eclipse-workspace\\LURG\\res\\pistol2.png", other);
	
	public static Texture ui_texture = new Texture("C:\\Users\\rafas\\eclipse-workspace\\LURG\\res\\ui.png", other);
	...
	public Texture(String location, String type) {
		...
		else if (type.equals(menu) || type.equals(other)) pixels = new int[Game.WID * Game.HEI];  
		load();
	}

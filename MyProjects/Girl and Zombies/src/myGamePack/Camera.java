...
public class Camera implements KeyListener {
	...
	public boolean left, right, enter, one, two, three, four, five, six, seven, eight, nine, zero, escape;
	public static boolean forward, back;
	...
	public void changeCeil() {
		if (top_i % 32 < 16) {
			Screen.in_doors = false;
			Screen.sky = skybox_textures[top_i];
		} else {
			Screen.in_doors = true;
			Screen.ceiling_texNum = ceiling_textures[top_i%16];
		}
		top_i = (top_i + 1) % 32;
	}
	...
	public void update(int[][] map) {
	    if (enter && isMenu) {
	    	isMenu = false;
	    	Sound.stopSound();
	    	Sound.playSound("C:\\Users\\rafas\\eclipse-workspace\\LURG\\res\\start.wav", false);
	    	Sound.playSound("C:\\Users\\rafas\\eclipse-workspace\\LURG\\res\\game.wav", true);
	    }
	    if (escape) {
	    	System.exit(0);
	    }

...
public class Game extends JFrame implements Runnable{
	...
	public Game(String worldName, int renderDistance, boolean skySelfMovement, double walkingSpeed, 
            double turningSpeed, String skyboxId, int fog_col) {
        ...
        try {
            ...
            screen = new Screen(layer0, layer1, event_data, MAX_WORLD_LIMIT, allTextures, game_width, game_height, pixel_effect, fog_col, skyboxId, skySelfMovement, renderDistance, world_light_factor);

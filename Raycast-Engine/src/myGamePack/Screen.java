...
public class Screen {
	...
	public Screen(String[][] layer0, String[][] layer1, String[] event_data, int MAX_WORLD_LIMIT,
			...
			String skyboxId, boolean skySelfMovement, int renderDistance, double world_light_factor, int[] pixels, Camera camera) {
		this.layer0 = layer0;
		this.layer1 = layer1;
		...
		sprite_render_dist = 2*render_dist;
	...
	// TODO: We have to figure out how to handle Sprites
	
	public int getPixelEffect() {
		return pixel_effect;
	}
	
	public void setPixelEffect(int pixel_effect) {
		this.pixel_effect = pixel_effect;
	}

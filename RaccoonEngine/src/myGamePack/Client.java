            ...
            try {
                ...
                while ((serverMessage = in.readLine()) != null) {
                    if (serverMessage.contains("COORDSXY")) {
                        ...
                        Game.map[Integer.parseInt(parts[1].trim())][Integer.parseInt(parts[2].trim())] = 715; // This is prob gonna be more involved. But the idea is putting sprite in new place, and restoring that there is ntohign where it was
                    } else {

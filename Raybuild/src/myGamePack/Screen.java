	...
	public int[] update(Camera camera, int[] pixels, int frames) {
		if (camera.isMenu) {
			...
			for (int i = 0; i < pixels.length; i++) {
				pixels[i] = textures.get(menu_texture-1).extras[i];
			}
		} else {
        ...
        // here you can display any extra stuff using Extras array, check if player hits a certain position and this is the special event that triggers things
	    // if you want to save or check your information in the GLOBALs array you can too. this is an empty array you can use as you see fit
